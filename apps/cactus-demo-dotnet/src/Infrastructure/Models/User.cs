...
public class UserDbModel
{
    ...
    public List<CredentialDbModel>? Credentials { get; set; } = new List<CredentialDbModel>();

    public DestinationCalendarDbModel? DestinationCalendar { get; set; } = null;

    public List<MembershipDbModel>? Teams { get; set; } = new List<MembershipDbModel>();
    ...
    public List<SelectedCalendarDbModel>? SelectedCalendars { get; set; } =
        new List<SelectedCalendarDbModel>();

    public List<WebhookDbModel>? Webhooks { get; set; } = new List<WebhookDbModel>();

    public List<ImpersonationDbModel>? ImpersonatedUsers { get; set; } =
        new List<ImpersonationDbModel>();

    public List<ImpersonationDbModel>? ImpersonatedBy { get; set; } =
        new List<ImpersonationDbModel>();

    public List<ApiKeyDbModel>? ApiKeys { get; set; } = new List<ApiKeyDbModel>();

    public List<AccountDbModel>? Accounts { get; set; } = new List<AccountDbModel>();
    ...
    public List<WorkflowDbModel>? Workflows { get; set; } = new List<WorkflowDbModel>();
}
