...
namespace CactusDemoDotnet.Infrastructure;

public class CactusDemoDotnetDbContext : DbContext
{
    public CactusDemoDotnetDbContext(DbContextOptions<CactusDemoDotnetDbContext> options)
        : base(options) { }
