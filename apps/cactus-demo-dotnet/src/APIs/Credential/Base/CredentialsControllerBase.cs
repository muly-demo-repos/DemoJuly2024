...
public abstract class CredentialsControllerBase : ControllerBase
{
    ...
    public async Task<ActionResult> ConnectDestinationCalendars(
    ...
    )
    {
        try
        {
            await _service.ConnectDestinationCalendars(uniqueId, destinationCalendarsId);
        }
    ...
    public async Task<ActionResult> DisconnectDestinationCalendars(
        [FromRoute()] CredentialWhereUniqueInput uniqueId,
    ...
    )
    {
        try
        {
            await _service.DisconnectDestinationCalendars(uniqueId, destinationCalendarsId);
        }
        catch (NotFoundException)
        {
            return NotFound();
    ...
    public async Task<ActionResult<List<DestinationCalendar>>> FindDestinationCalendars(
        [FromRoute()] CredentialWhereUniqueInput uniqueId,
    ...
    )
    {
        try
        {
            return Ok(await _service.FindDestinationCalendars(uniqueId, filter));
        }
        catch (NotFoundException)
        {
            return NotFound();
    ...
    public async Task<ActionResult> UpdateDestinationCalendars(
        [FromRoute()] CredentialWhereUniqueInput uniqueId,
        [FromBody()] DestinationCalendarWhereUniqueInput[] destinationCalendarsId
    )
    {
        try
        {
            await _service.UpdateDestinationCalendars(uniqueId, destinationCalendarsId);
        }
        catch (NotFoundException)
        {
            return NotFound();
